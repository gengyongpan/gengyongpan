	...
	'bleachbypass': {
		...
		fragmentShader: [
			...
			"void main() {",
				...
				"float A2 = opacity _2A base.a;",
				"vec3 mixRGB = A2 _2A newColor.rgb;",
	...
	'fxaa': {
		...
		fragmentShader: [
			...
			"void main() {",
				...
				"vec3 rgbNW = texture2D( tDiffuse, ( gl_FragCoord.xy + vec2( -1.0, -1.0 ) ) _2A resolution ).xyz;",
				"vec3 rgbNE = texture2D( tDiffuse, ( gl_FragCoord.xy + vec2( 1.0, -1.0 ) ) _2A resolution ).xyz;",
				"vec3 rgbSW = texture2D( tDiffuse, ( gl_FragCoord.xy + vec2( -1.0, 1.0 ) ) _2A resolution ).xyz;",
				"vec3 rgbSE = texture2D( tDiffuse, ( gl_FragCoord.xy + vec2( 1.0, 1.0 ) ) _2A resolution ).xyz;",
				"vec3 rgbM  = texture2D( tDiffuse,  gl_FragCoord.xy  _2A resolution ).xyz;",
